...
@ComponentScans(value = { @ComponentScan("com.Pharmacia.crud.dao"), @ComponentScan("com.Pharmacia.crud.service") })
public class AppConfig {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		factoryBean.setAnnotatedClasses(
				new Class[] { Product.class, ProductDetails.class, Category.class, User.class, Role.class });
